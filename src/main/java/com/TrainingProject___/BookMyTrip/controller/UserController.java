package com.TrainingProject___.BookMyTrip.controller;
...
import com.TrainingProject___.BookMyTrip.exception.UserValidationException;
import com.TrainingProject___.BookMyTrip.serviceImpl.UserServiceImpl;
...
public class UserController {
	...
	@GetMapping("/findBus/{arrivalDepot}/{departureDepot}/{date}")
	public ResponseEntity<BusDetails> findByRouteAndDate(@PathVariable String arrivalDepot,@PathVariable String departureDepot,@PathVariable String date){
		BusDetails details = service.findByRouteAndDate(arrivalDepot, departureDepot, date);
		return ResponseEntity.ok().body(details);
	}
