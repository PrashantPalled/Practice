...
import com.TrainingProject___.BookMyTrip.dao.UserDao;
...
import com.TrainingProject___.BookMyTrip.exception.NullUserException;
import com.TrainingProject___.BookMyTrip.exception.PassengerNotFoundException;
import com.TrainingProject___.BookMyTrip.exception.UserAlreadyExistException;
import com.TrainingProject___.BookMyTrip.exception.UserDoesnotExistException;
import com.TrainingProject___.BookMyTrip.service.UserService;
...
public class UserServiceImpl implements UserService{
	...
	public List<BookingDetails> getBookingByUserId(Integer userId) {
		...
		System.err.println("========================================");
		List<BookingDetails> list = user.get().getBookingDetails();
	...
	public BusDetails findByRouteAndDate(String arrivalDepot, String departureDepot, String date) {
		List<BusDetails> list = busDao.findByRouteDate(arrivalDepot.toLowerCase(),
